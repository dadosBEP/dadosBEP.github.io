function calcularRV() {
    ...
    if (clientes < 6 || vendas < 10 || tpv < 5000) {
        valorComissao = 0;
    } else if (tpv >= 5000 && tpv < 6500) {
        if (vendas >= 10 && vendas <= 11) valorComissao = 135;
        else if (vendas >= 12 && vendas <= 13) valorComissao = 135;
        else if (vendas >= 14) valorComissao = 180;
    } else if (tpv >= 6500 && tpv < 7500) {
        if (vendas >= 10 && vendas <= 11) valorComissao = 180;
        else if (vendas >= 12 && vendas <= 13) valorComissao = 225;
        else if (vendas >= 14) valorComissao = 450;
    } else if (tpv >= 7500) {
        if (vendas >= 10 && vendas <= 11) valorComissao = 180;
        else if (vendas >= 12 && vendas <= 13) valorComissao = 225;
        else if (vendas >= 14) valorComissao = 450;
    ...
    if (migracao < 30 || tpv < 5000 || clientes < 6 || vendas < 7) {
	valorPremiacao = 0;
    } 
